...
class UserListDataSourse {
        internal val mUserListLiveData: MutableLiveData<RatingResponse> = MutableLiveData<RatingResponse>()

    fun requestUserList(groupIdx:String,userIdx: ProfileRequest) : LiveData<RatingResponse> {
