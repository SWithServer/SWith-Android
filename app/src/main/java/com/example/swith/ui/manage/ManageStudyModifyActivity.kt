...
class ManageStudyModifyActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(
            ...
            R.layout.activity_manage_study_modify
        )
            ...
            btnStudyModify.setOnClickListener {
                with(binding)
                {
                    ...
                    var studyRequestData = StudyGroup(
                        SharedPrefManager(this@ManageStudyModifyActivity).getLoginData()!!.userIdx,
                        ImgUri,
                        title,
                        meet_idx,
                        frequency_content,
                    ...
                    if (response.isSuccessful) {
                        ...
                        response.body()?.apply {
                            ...
                            if (ImgUri == null || ImgUri.equals("")) {
                                ...
                                Log.e("주소 있음 진입", "true")
                                Glide.with(this@ManageStudyModifyActivity).load(ImgUri)
                                    .into(binding.ivStudyCreate)
                            }
                            with(binding)
                            {
                                    ...
                                    1 -> {
                                        ...
                                        if (result.regionIdx1 != null) {
                                            ...
                                            binding.btnPlusPlace1.background =
                                                ContextCompat.getDrawable(
                                                    this@ManageStudyModifyActivity,
                                                    R.drawable.bg_create_select_blue
                                                )
                                        } else {
                                            btnPlusPlace1.text = "+"
                                            binding.btnPlusPlace1.background =
        ...
        retrofitService.modifyStudy(groupIdx.toLong(), studyRequestData)
            .enqueue(object : Callback<StudyModifyResponse> {
                ...
                override fun onFailure(call: Call<StudyModifyResponse>, t: Throwable) {
                    Log.e("summer", "onFailure t = ${t.toString()}")
                    Log.e("summer", "onFailure msg = ${t.message}")
                    Toast.makeText(this@ManageStudyModifyActivity, "다시 시도해주세요", Toast.LENGTH_SHORT)
                        .show()
                    dialog_.dismiss()
                }
            })
