                        ...
                        response.body()?.apply {
                            ...
                            with(binding)
                            {
                                ...
                                when (result.interestIdx1.toInt()) {
                                    1 -> {
                                        tvInteresting1.text = "자격증/시험"
                                    }
                                    2 -> {
                                        tvInteresting1.text = "어학"
                                    }
                                    3 -> {
                                        tvInteresting1.text = "청소년/입시"
                                    }
                                    4 -> {
                                        tvInteresting1.text = "취업/창업"
                                    }
                                    5 -> {
                                        tvInteresting1.text = "컴퓨터/IT"
                                    }
                                    6 -> {
                                        tvInteresting1.text = "취미/문화"
                                    }
                                    7 -> {
                                        tvInteresting1.text = "면접"
                                    }
                                }
