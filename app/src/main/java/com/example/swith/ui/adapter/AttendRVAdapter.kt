...
import com.example.swith.entity.GetAttendance

class AttendRVAdapter(private val userId: Long?) :
    RecyclerView.Adapter<AttendRVAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: ItemAttendBinding) :
