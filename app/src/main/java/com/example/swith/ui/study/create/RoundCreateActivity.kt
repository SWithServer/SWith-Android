...
open class RoundCreateActivity : AppCompatActivity(), View.OnClickListener {
    ...
    protected open fun initListener() {
        ...
        with(binding) {
            ...
            btnCreateStartDate.setOnClickListener {
                if (startTime != null && endTime != null) tvRoundCreateAlert.visibility =
                    View.VISIBLE
            ...
            btnCreateAdd.setOnClickListener {
                ...
                if (checkCondition()) {
                    BottomSheet(
                        "회차 생성",
                        null,
                        resources.getString(R.string.bottom_round_create_guide),
                        "생성"
                    ).apply {
                            ...
                            override fun onCheckClick() {
                                ...
                                viewModel.postRound(
                                    Session(
                                        groupIdx,
                                        online,
                                        etCreatePlace.text.toString(),
                                        etCreateDetail.text.toString(),
                                        endTimeToString,
                                        startTimeToString,
                                        userId
                                    )
                    ...
                    dialogBinding.npHourPicker.apply {
                        ...
                        with(ZonedDateTime.now(ZoneId.of("Asia/Seoul"))) {
                            ...
                            if (!isStart && startTime != null && startTime?.year == dateYear && startTime?.month == monthOfYear + 1 && startTime?.day == dayOfMonth) {
                                ...
                                minValue =
                                    if (startTime?.minute!! >= 60 - minuteMin) startTime?.hourOfDay!! + 1 else startTime?.hourOfDay!!
                                value = minValue
                            ...
                            // maxValue 부분
                            maxValue =
                                if (isStart && endTime != null && endTime?.year == dateYear && endTime?.month == monthOfYear + 1 && endTime?.day == dayOfMonth) {
                                            ...
                                            startTime?.hourOfDay!! + 1 -> {
                                                if (startTime?.minute!! + minuteMin >= 60) {
                                                    displayedValues = arrayOf(
                                                        ...
                                                        "40",
                                                        "50"
                                                    ).sliceArray(((startTime?.minute!! + minuteMin - 60) / 10) % 6..5)
                                                    minValue =
                                                        ((startTime?.minute!! + minuteMin - 60) / 10) % 6
                                                } else {
                                                    displayedValues =
                                                ...
                                                endTime?.hourOfDay!! -> {
                                                    if (endTime?.minute == minuteMin) {
                                                        ...
                                                        displayedValues = arrayOf(
                                                            ...
                                                            "40",
                                                            "50"
                                                        ).sliceArray(0..(endTime?.minute!! - minuteMin) / 10)
                                                        minValue = 0
                                                        maxValue =
                                                            (endTime?.minute!! - minuteMin) / 10
                                                    }
                                                }
                                                endTime?.hourOfDay!! - 1 -> {
                                                    if (endTime?.minute!! < minuteMin) {
                                                        if (day == dayOfMonth && newVal == hour) {
                                                            displayedValues = arrayOf(
                                                                ...
                                                                "40",
                                                                "50"
                                                            ).sliceArray(minuteIdx + 1..(endTime?.minute!! + 60 - minuteMin) / 10)
                                                            ...
                                                            displayedValues = arrayOf(
                                                                ...
                                                                "40",
                                                                "50"
                                                            ).sliceArray(0..(endTime?.minute!! + 60 - minuteMin) / 10)
                                                            minValue = 0
                                                        }
                                                        maxValue =
                                                            (endTime?.minute!! + 60 - minuteMin) / 10
                                                    } else {
                                                        displayedValues = arrayOf(
                                                            "0",
                                                            "10",
                                                ...
                                                (endTime?.hourOfDay!! + 24 - hourMax) % 24 -> {
                                                    ...
                                                    if (newVal == 23 && endTime?.hourOfDay == 0 && endTime?.minute!! < minuteMin) {
                                                        displayedValues = arrayOf(
                                                            ...
                                                            "40",
                                                            "50"
                                                        ).sliceArray(0..(endTime?.minute!! - minuteMin + 60) / 10)
                                                        maxValue =
                                                            (endTime?.minute!! - minuteMin + 60) / 10
                                                    } else {
                                                        displayedValues = arrayOf(
                                                            "0",
                                                            "10",
                    ...
                    dialogBinding.npMinutePicker.apply {
                        ...
                        with(ZonedDateTime.now(ZoneId.of("Asia/Seoul"))) {
                            if (!isStart && startTime != null) {
                                ...
                                if (startTime?.day == dayOfMonth) {
                                    if (startTime?.hourOfDay.toString() == dialogBinding.npHourPicker.value.toString()) {
                                        ...
                                        minValue =
                                            ((startTime?.minute!! / 10) + (minuteMin / 10)) % 6
                                        maxValue = 5
                                        displayedValues =
                                            arrayOf("0", "10", "20", "30", "40", "50").sliceArray(
                                                minValue..5
                                    ...
                                    maxValue =
                                        if (dialogBinding.npHourPicker.value == startTime?.hourOfDay!! + hourMax - 24)
                                            startTime?.minute!! / 10
                                        else 5
                                    displayedValues =
                                        arrayOf("0", "10", "20", "30", "40", "50").sliceArray(
                                            ...
                                            if (hour == dialogBinding.npHourPicker.value) {
                                                displayedValues = arrayOf(
                                                    ...
                                                    max(
                                                        0,
                                                        minute / 10 + 1
                                                    )..(endTime?.minute!! / 10) - (minuteMin / 10)
                                                )
                                                ...
                                                displayedValues = arrayOf(
                                                    ...
                                                    "40",
                                                    "50"
                                                ).sliceArray((minute / 10 + 1) % 6..(endTime?.minute!! / 10) - (minuteMin / 10))
                                        ...
                                        if (dialogBinding.npHourPicker.value + 1 == endTime?.hourOfDay && endTime?.minute!! < minuteMin) {
                                            if (dialogBinding.npHourPicker.value == hour) {
                                                displayedValues = arrayOf(
                                                    ...
                                                    "40",
                                                    "50"
                                                ).sliceArray(minute / 10 + 1..(endTime?.minute!! - minuteMin + 60) / 10)
                                                minValue = minute / 10 + 1
                                            } else {
                                                displayedValues = arrayOf(
                                                    "0",
                            ...
                            // 오늘이 아닌 경우
                                ...
                                if (!isStart && year == dateYear && monthValue == monthOfYear && hour == 23 && minute >= 60 - minuteMin) {
                                    ...
                                    if (calendar.get(Calendar.DAY_OF_MONTH) == dayOfMonth) {
                                        displayedValues = arrayOf(
                                            ...
                                            "40",
                                            "50"
                                        ).sliceArray((minute + minuteMin - 60) / 10..5)
                                ...
                                minValue =
                                    if (isStart) minute / 10 + 1 else ((minuteMin + minute) / 10 + 1) % 6
                                displayedValues = arrayOf(
                                    "0",
                                    "10",
                                    "20",
                                ...
                                minValue =
                                    if (!isStart && year == dateYear && monthValue == monthOfYear + 1 && day == dayOfMonth && hour.plus(
                                            1
                                        ).toString() == dialogBinding.npHourPicker.value.toString()
                                    ) {
                            ...
                            override fun roundCreate() {
                                if (isStart) {
                                    ...
                                    startTime = DateTime(
                                        ...
                                        monthOfYear + 1,
                                        dayOfMonth,
                                        dialogBinding.npHourPicker.value,
                                        dialogBinding.npMinutePicker.value * 10
                                    )
    ...
    private fun setAddButton() {
        with(binding) {
            btnCreateAdd.apply {
                visibility =
                    if (!etCreatePlace.text.isNullOrBlank() && !etCreateDetail.text.isNullOrBlank() && startTime != null && endTime != null) View.VISIBLE else View.INVISIBLE
            }
        }
    }
    ...
    private fun compareStartEndTime(): Int {
        ...
        startTime?.let {
            endTime?.let {
                ...
                val endTimeToLong = String.format(
                    "%4d%02d%02d%02d%02d",
                    endTime?.year,
                    endTime?.month,
                    endTime?.day,
    ...
    private fun checkCondition(): Boolean {
        startTime?.let {
            with(ZonedDateTime.now(ZoneId.of("Asia/Seoul"))) {
                ...
                val nowTimeToLong =
                    String.format("%4d%02d%02d%02d%02d", year, monthValue, day, hour, minute)
                        .toLong()
                if (startTimeToLong <= nowTimeToLong) {
                    CustomAlertDialog("시작시간 오류", "시작시간이 현재 시간보다 전입니다.\n시간 초기화 후 다시 설정해주세요.").show(
                    ...
                    endTime?.let {
                        ...
                        if (startTime?.day == endTime?.day && endTimeToLong - startTimeToLong > 800) {
                            CustomAlertDialog(
                                "회차시간 오류",
                                "회차 시간이 8시간 보다 깁니다. \n시간 초기화 후 다시 설정해주세요."
                            ).show(supportFragmentManager, "endTimeAlert")
                            return false
                        }
                    }
                }
