...
class RatingActivity : AppCompatActivity(), View.OnClickListener, Observer<RatingResponse> {
    ...
    private fun initView() {
        ...
        mRatingViewModel = ViewModelProvider(this@RatingActivity, RatingViewModel.Factory()).get(RatingViewModel::class.java).apply {
            this.getCurrentUserList().observe(this@RatingActivity, this@RatingActivity)
        }
        mRatingViewModel?.requestCurrentUserList(groupIdx, ProfileRequest(2))
