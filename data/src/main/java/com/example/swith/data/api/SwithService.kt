package com.example.swith.data.api
...
interface SwithService {
    ...
    fun postUserResume(
        @Path("groupIdx") groupIdx: Long,
        @Path("status") status: Int,
        @Body body: ManageUserResumeReq
    ): Call<ManageUserResumeResponse>
    ...
    fun deleteUser(
        @Path("groupIdx") groupIdx: Long,
        @Path("status") status: Int,
        @Body body: ManageUserDelReq
    ): Call<ManageUserDelResponse>
    ...
    fun getRating(
        ...
        @Body ratingBody: ProfileRequest
    ): Call<RatingResponse>
